...
socket.on('statusNow', (payload) => {
    ...
    if(t1) {
        ...
        lblEscritorio1.innerText = t1.window;
    }

    if(t2) {
        lblTicket2.innerText = 'Ticket-' + t2.number;
        lblEscritorio2.innerText = t2.window;
    }

    if(t3) {
        lblTicket3.innerText = 'Ticket-' + t3.number;
        lblEscritorio3.innerText = t3.window;
    }

    if(t4) {
        lblTicket4.innerText = 'Ticket-' + t4.number;
        lblEscritorio4.innerText = t4.window;
    }
});
